/*
  ...
  - Ejercicio desde: https://2021.adventjs.dev/challenges/11
...
export function shouldBuyFidelity(times) {
  let totalTicketDeUnSoloUso = times * 12;
  let sumatoria = 0;
  for (let i = 1; i <= times; i++) {
    sumatoria += 12 * Math.pow(0.75, i);
  }
  let totalTarjetaFidelidad = sumatoria + 250;

  return totalTarjetaFidelidad < totalTicketDeUnSoloUso;
}
